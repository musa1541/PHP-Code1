...
try {
    ...
    $stmt = $pdo->prepare('UPDATE students SET firstname = ?, lastname = ?, age = ?, email = ?, reg_date = ?, course = ? WHERE id = ' . $_GET['id']);
    ...
    header("location: form.php?message=Data Updated Successfully!");
}
